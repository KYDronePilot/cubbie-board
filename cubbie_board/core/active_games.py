...
class ActiveGames:
    ...
    def refill(self):
        ...
        active_games += self.get_recent_finals(games)
    ...
    def get_recent_finals(self, games):
        ...
        for game in final:
            ...
            if 'delay' in sb.elapsed_time:
                ...
                delay_hours, delay_minutes = self.hours_minutes_convert(delay_time)
                dur_hours, dur_minutes = self.hours_minutes_convert(dur_time)
            ...
            # If no delay in game, extra hours and minutes here.
                ...
                hours, minutes = self.hours_minutes_convert(time)
